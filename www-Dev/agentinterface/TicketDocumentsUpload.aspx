      ...
      Select Case _Mode.ToLower
        Case "doc"
         ...
         tkd.Add (2, _TicketID, drpDocTypes.SelectedValue,lng)
                    ...
                    'production
                    If drpDocTypes.SelectedValue = 12 Then  ' return shipping label
                        ...
                        plog.Add(Master.WebLoginID ,Now(),9,"A Return shipping label has been uploaded into ticket: " & _TicketID)
                        ...
                        eml.Body = "A Return shipping label has been uploaded into ticket: " & _TicketID
                        ...
                        'End If
                    Else
                        plog.Add(Master.WebLoginID ,Now(),10,"A Document or Photo has been uploaded into ticket: " & _TicketID)
