...
<script runat="server">  
  ...
  Private Sub Page_Load(ByVal s As Object, ByVal E As EventArgs)        
    If User.Identity.IsAuthenticated Then
      ...
      Master.PageSubHeader = "<a href=""default.aspx"">My Desktop</a> &gt; <a href=""partners.aspx"">Partner Management</a> &gt; <a href=""" & Request.QueryString("returnurl") & """>Partner Information</a> &gt; Skill Set Survey"
      Try
    ...
    If lblReturnUrl.Text.Trim.Length = 0 Then
      lblReturnUrl.Text = "partners.aspx"
    End If    
  End Sub
  ...
  Private Sub btnApply_Click(ByVal S As Object, ByVal E As EventArgs)
    If IsComplete() Then
      divErrors.Visible = False
      SaveAnswers()
      Response.Redirect("skillsetsurvey.aspx?id=" & _ID.ToString & "&returnurl=" & Request.QueryString("returnurl").Replace("?", "%3f"), True)
    Else
      divErrors.Visible = True
    End If    
  End Sub
