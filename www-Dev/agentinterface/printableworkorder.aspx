...
<script runat="server">
  ...
  Private Sub LoadWorkOrder()
    ...
    'lblSurveyEmail.Text = wrk.SurveyEmail
        If wrk.ClosingAgent > 0 Then
            ...
            lblResolutionNote.Text = wrk.ResolutionNote.Replace(Environment.NewLine, "<br/>")
  ...
  Private Sub LoadTicket()
    ...
    'lblRequestedStartDate.Text = tkt.RequestedStartDate
        ...
        lblDateReceived.Text = tkt.DateCreated
...
<head runat="server">
  ...
  <body class="paper">
    <form id="frmTicket" runat="server">
          ...
          <td>
              ...
              <table cellspacing="0">
                ...
                <tr>
                  ...
                  <td>&nbsp;</td>
                  <td><asp:Label ID="lblDateReceived" runat="server" /></td>
                </tr>
                <tr>
      ...
      <div><asp:Label ID="lblResolutionNote" runat ="server"></asp:Label></div>
      <div>&nbsp;</div>
      <div>&nbsp;</div>
      <div>&nbsp;</div>
      <div>&nbsp;</div>
