...
<script runat="server">  
  ...
  Private Sub Page_Load(ByVal s As Object, ByVal E As EventArgs)
    If User.Identity.IsAuthenticated Then
      ...
      Master.PageHeaderText = " Upload Partner Documents"
      Master.PageTitleText = " Upload Partner Documents"
    End If
    Try
    ...
    If IsComplete() Then
      ...
      Select Case _Mode.ToLower
        Case "doc"
         ...
         rnt.Add(CType(ptr.ResumeID, Long), Master.UserID, "Auto Note: New Document has been attached to the Vendor's Account: " & drpDocTypes.SelectedItem.ToString())
