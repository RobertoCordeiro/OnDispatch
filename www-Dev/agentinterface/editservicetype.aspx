...
<script runat="server"> 
  ...
  Private Sub LoadServiceType()
    ...
    txtNotes.Text = stp.Notes
        ...
        txtApplyPartMarkup.Text = stp.ApplyPartMarkup
  ...
  Private Sub btnOk_Click(ByVal S As Object, ByVal E As EventArgs)
    If IsComplete() Then
      ...
      stp.Notes = txtNotes.Text
            ...
            stp.ApplyPartMarkup = txtApplyPartMarkup.Text
...
<asp:Content ContentPlaceHolderID="bodycontent" ID="cntBody" runat="server">
  <form id="frmDialog" runat="server">
    ...
    <asp:TextBox ID="txtNotes" runat="server" TextMode="MultiLine" style="width: 99%; Height: 100px" />
      <div>&nbsp;</div>
      <div class="label">Apply Part Markup (%)</div>
    <asp:TextBox ID="txtApplyPartMarkup" runat="server" style="width: 50%" />
    <div>&nbsp;</div>
