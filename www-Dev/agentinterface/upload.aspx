      ...
      Select Case _Mode.ToLower
        Case "wo"
          ...
          If wrk.WorkOrderID > 0 Then
             ...
             if not chkRPW.Checked then
                wrk.WorkOrderFileID = 0
             else
                wrk.WorkOrderFileID = lng
                        ...
                        tnt.Add(wrk.TicketID, Master.WebLoginID, Master.UserID, "Auto Note: Agent has uploaded signed work order: " & wrk.WorkOrderID.ToString)
...
<asp:Content ContentPlaceHolderID="bodycontent" ID="cntBody" runat="server">
  <form id="frmDialog" runat="server">
    ...
    <div></div> 
    <asp:checkbox ID="chkRPW" runat="server" Text="Work Order Returned" />
