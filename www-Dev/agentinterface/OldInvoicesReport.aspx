...
<script runat="server">
  ...
  Private Sub Page_Load(ByVal s As Object, ByVal E As EventArgs)
    ...
    End Try
        ...
        report = New Reports.rptOldInvoices(System.Configuration.ConfigurationManager.AppSettings("DBCnn"))
...
<form id="form1" runat="server">
    <div>
        <telerik:ReportViewer ID="ReportViewer1" runat="server" Height="537px" Width="100%" ZoomMode="FullPage" Report="Reports.rptOldInvoices, Reports, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null" />
