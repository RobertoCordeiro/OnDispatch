...
<script runat="server"> 
  ...
  Private Sub Page_Load(ByVal s As Object, ByVal E As EventArgs)
    ...
    End Try
    If _ID > 0 Then
      Master.PageSubHeader &= "<a href=""customer.aspx?id=" & _ID & """>Customer</a> &gt; Add Agent"
  ...
  Private Sub btnSubmit_Click(ByVal S As Object, ByVal E As EventArgs)
    If IsComplete() Then
      ...
      cag.Add(_ID, cbxAgentTypes.SelectedValue, Master.UserID, fnlAgent.FirstName, fnlAgent.LastName, chkAdminAgent.Checked)
