  ...
  <form id="frmTicket" runat="server" style="background-color: #EAEAEA;">
    <div id="divTicket" runat="server" visible="true">
      ...
      <table style="width: 100%; background-color: White;">
        <tbody>
          <tr>          
            <td style="width: 64px;"><asp:Image ID="imgPriority" runat="server" /><a id="lnkPriority" runat="server">[Change Priority]</a></td>
            <td class="ticketsectionheader" style="text-align: center;"><a id="lnkPrintable" runat="server"><img src="/graphics/printable.png" style="border: 0" alt="Printable Version" /></a><asp:Label ID="lblCompanyName" runat="server" /> Ticket <a id="lnkEditTicket" runat="server">[Edit]</a></td>
      ...
      <div>&nbsp;</div>
      <div class="ticketformsectionheader">On Site Instructions</div>
      ...
      <asp:DataGrid ID="dgvComponents" runat="server" AutoGenerateColumns="false" style="width: 100%; background-color: White;">
        ...
        <Columns>      
          ...
          <asp:TemplateColumn HeaderText="Command">
            <ItemTemplate>
              <%#EditComponentLink(DataBinder.Eval(Container.DataItem, "TicketComponentID"))%>
            </ItemTemplate>
          </asp:TemplateColumn>
          ...
          <asp:TemplateColumn headertext="Ship To">
            <ItemTemplate>
              <%#ShipToText(DataBinder.Eval(container.DataItem,"WorkOrderID")) %>
            </ItemTemplate>
          </asp:TemplateColumn>
          ...
          <asp:TemplateColumn HeaderText="Shipping Labels">
            <ItemTemplate>
              ...
              <div style="text-align: right;"><%#AddShippingLabelLink(DataBinder.Eval(Container.DataItem, "TicketComponentID"))%></div>
            </ItemTemplate>
          </asp:TemplateColumn>
        </Columns>
      </asp:DataGrid>
      <div style="text-align: right;"><a id="lnkAddComponent" runat="server">[Add Component]</a></div>
      <div>&nbsp;</div>
