<%@ Page Language="vb" masterpagefile="~/masters/FieldTechnicians.master" MaintainScrollPositionOnPostback = "True" %>
  ...
  End Sub
    ...
    Private Sub LoadTicketsByOldInvoiceID(ByVal lngInvoiceID As Long)
        ...
        Else
            ...
            lblTicketCount.Text = " ( " & CType(dgvChargeParts.DataSource, Data.DataSet).Tables(0).Rows.Count & " ) "
             ...
             BackColor="#C0C0C0" />
                ...
                <Columns>
                  ...
                  <asp:TemplateColumn SortExpression="TicketID" HeaderText="Ticket&nbsp;ID">
                    <ItemTemplate>
                     <a target="_blank" href="ticket.aspx?id=<%# DataBinder.Eval(Container.DataItem,"TicketID") %>&act=L"><%# DataBinder.Eval(Container.DataItem,"TicketID") %></a><a target="_blank" href="printableticket.aspx?id=<%# DataBinder.Eval(Container.DataItem,"TicketID") %>"><img style="border: 0" alt="Printable Version" src="/graphics/printable.png" /></a>
                    </ItemTemplate>
                  </asp:TemplateColumn>
