...
<asp:Content ContentPlaceHolderID="bodycontent" ID="cntBody" runat="server">
  <form id="frmWorkOrders" runat="server">
    <div class="inputformsectionheader"><asp:Label ID="lblTicketCount" runat="server"></asp:Label> Tickets Needing Work Order Uploaded or Faxed to 561-886-6690</div>
        <asp:DataGrid ID="dgvRequireUpload" runat="server" style="width: 100%; background-color:White;" AutoGenerateColumns="false">
