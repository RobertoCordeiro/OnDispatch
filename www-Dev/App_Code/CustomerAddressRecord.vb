...
Namespace BridgesInterface
    Public Class CustomerAddressRecord
        ...
        Public Sub New(ByVal lngCustomerAddressID As Long, ByVal strConnectionString As String)
            Me._CustomerAddressID = -1
            Me._CustomerID = -1
            Me._CreatedBy = -1
            Me._StateID = -1
            ...
            Me.ClearValues
            Me._ConnectionString = strConnectionString
            Me.Load(lngCustomerAddressID)
        End Sub

        Public Sub New(ByVal lngCustomerID As Long, ByVal lngAddressTypeID As Long, ByVal strConnectionstring As String)
            Me._CustomerAddressID = -1
            Me._CustomerID = -1
            Me._CreatedBy = -1
            Me._StateID = -1
            ...
            Me._ConnectionString = ""
            Me._ConnectionString = strConnectionstring
            Me.Load(lngCustomerID, lngAddressTypeID)
        End Sub

        Public Sub New(ByVal lngCustomerID As Long, ByVal lngCreatedBy As Long, ByVal lngStateID As Long, ByVal lngAddressTypeID As Long, ByVal strStreet As String, ByVal strCity As String, ByVal strZipCode As String, ByVal strConnectionString As String, ByVal Optional strExtended As String = "")
            Me._CustomerAddressID = -1
            Me._CustomerID = -1
            Me._CreatedBy = -1
            Me._StateID = -1
            ...
            Me._ConnectionString = strConnectionString
            Me.ClearValues
            Me.Add(lngCustomerID, lngCreatedBy, lngStateID, lngAddressTypeID, strStreet, strCity, strZipCode, strExtended)
        End Sub

        Public Function Add(ByVal lngCustomerID As Long, ByVal lngCreatedBy As Long, ByVal lngStateID As Long, ByVal lngAddressTypeID As Long, ByVal strStreet As String, ByVal strCity As String, ByVal strZipCode As String, ByVal Optional strExtended As String = "") As Long
            ...
            If (Me._ConnectionString.Trim.Length > 0) Then
                ...
                Dim cmd As New SqlCommand("spAddCustomerAddress")
        ...
        Public Sub Delete()
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spRemoveCustomerAddress")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@CustomerAddressID", SqlDbType.Int).Value = Me._CustomerAddressID
                cnn.Open
                cmd.Connection = cnn
                cmd.ExecuteNonQuery
                cnn.Close
                Me.Load(Me._CustomerAddressID)
            End If
        End Sub
        ...
        Private Function HasChanged() As Boolean
            ...
            Dim uaddCompare As New CustomerAddressRecord(Me._CustomerAddressID, Me._ConnectionString)
        ...
        Public Sub Load(ByVal lngCustomerAddressID As Long)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spGetCustomerAddress")
                cmd.CommandType = CommandType.StoredProcedure
        ...
        Public Sub Load(ByVal lngCustomerID As Long, ByVal lngAddressTypeID As Long)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spGetFirstCustomerAddressByType")
                cmd.CommandType = CommandType.StoredProcedure
        ...
        Private Sub LoadFromDataReader(ByRef dtr As SqlDataReader)
        ...
        Public Sub Save(ByRef Optional strChangeLog As String = "")
            Dim addCompare As New CustomerAddressRecord(Me._CustomerAddressID, Me._ConnectionString)
            strChangeLog = ""
        ...
        Private Sub UpdateActive(ByVal blnNewActive As Boolean)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateCustomerAddressActive")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@CustomerAddressID", SqlDbType.Int).Value = Me._CustomerAddressID
        ...
        Private Sub UpdateAddressTypeID(ByVal lngNewAddressTypeID As Long)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateCustomerAddressAddressTypeID")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@CustomerAddressID", SqlDbType.Int).Value = Me._CustomerAddressID
        ...
        Private Sub UpdateCity(ByVal strNewCity As String)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateCustomerAddressCity")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@CustomerAddressID", SqlDbType.Int).Value = Me._CustomerAddressID
        ...
        Private Sub UpdateExtended(ByVal strNewExtended As String)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateCustomerAddressExtended")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@CustomerAddressID", SqlDbType.Int).Value = Me._CustomerAddressID
        ...
        Private Sub UpdateStateID(ByVal lngNewStateID As Long)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateCustomerAddressStateID")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@CustomerAddressID", SqlDbType.Int).Value = Me._CustomerAddressID
        ...
        Private Sub UpdateStreet(ByVal strNewStreet As String)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateCustomerAddressStreet")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@CustomerAddressID", SqlDbType.Int).Value = Me._CustomerAddressID
        ...
        Private Sub UpdateZipCode(ByVal strNewZipCode As String)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateCustomerAddressZipCode")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@CustomerAddressID", SqlDbType.Int).Value = Me._CustomerAddressID
        ...
        Public ReadOnly Property CustomerAddressID As Long
            Get
