...
<script runat="server"> 
  ...
  Private Sub Page_Load(ByVal s As Object, ByVal E As EventArgs)
    If User.Identity.IsAuthenticated Then
      ...
      Master.PageHeaderText = " Edit Product Type"
      Master.PageTitleText = " Edit Product Type"
      Master.PageSubHeader = "<a href=""default.aspx"">My Desktop</a> &gt; <a href=""makers.aspx"">Product Type Model Control</a> &gt; Edit Product Type"
    End If
    Try
  ...
  Private Sub LoadProductType(ByVal lngID As Long)
    Dim ptp As New BridgesInterface.ProductTypeRecord(System.Configuration.ConfigurationManager.AppSettings("DBCnn"))
    ptp.Load(lngID)
    txtProductType.Text = ptp.ProductType
  End Sub
  ...
  Private Sub btnEdit_Click(ByVal S As Object, ByVal E As EventArgs)
    ...
    If isComplete() Then
      ...
      Dim ptp As New BridgesInterface.ProductTypeRecord(System.Configuration.ConfigurationManager.AppSettings("DBCnn"))
      ptp.Load(_ID)
      ptp.ProductType = txtProductType.Text
      ptp.Save(strChangeLog)
      ...
      If IsNothing(strType) Then
        strType = "web"
      End If
      act.Add(2, "web", strType, strIp, "web", 29, ptp.ProductTypeID, strChangeLog)
      Response.Redirect(lblReturnUrl.Text, True)
    Else
