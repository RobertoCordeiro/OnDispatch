...
Partial Public Class InvoiceSingle
    Inherits Report
    Public Sub New()
        InitializeComponent()
    ...
    Private Sub srptParts_NeedDataSource(ByVal sender As Object, ByVal e As System.EventArgs) Handles srptParts.NeedDataSource
