...
<asp:Content ContentPlaceHolderID="bodycontent" ID="cntBody" runat="server">
  <form id="frmDialog" runat="server">
    <asp:DataGrid style="width: 100%" ID="dgvLayers" AutoGenerateColumns="false" runat="server">
      ...
      <Columns>
         <asp:BoundColumn HeaderText="ID" DataField="LayerID" visible="False" />
         <asp:TemplateColumn>
          <Itemtemplate>
            <a href="EditLayers.aspx?id=<%# DataBinder.Eval(Container.DataItem,"LayerID") %>&returnurl=CreateLayer.aspx">Edit</a>
          </Itemtemplate>
        </asp:TemplateColumn>
