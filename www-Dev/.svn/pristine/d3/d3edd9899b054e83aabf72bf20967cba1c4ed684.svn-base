...
<script runat="server">
  ...
  Private Sub Page_Load(ByVal s As Object, ByVal E As EventArgs)
    If User.Identity.IsAuthenticated Then
      ...
      Master.PageSubHeader = "<a href=""default.aspx"">My Desktop</a> &gt; Add Phone Number"
      Try
  ...
  Private Sub SaveCustomerPhone()
    ...
    cpn.Add(_ID, phn.PhoneTypeID, Master.UserID, "1", phn.AreaCode, phn.Exchange, phn.LineNumber)
  ...
  Private Sub SavePartnerPhone()
    ...
    Dim strChangeLog As String = ""
    ppn.Add(_ID, phn.PhoneTypeID, Master.UserID, "1", phn.AreaCode, phn.Exchange, phn.LineNumber)
