...
<script runat="server">
  ...
  Private Sub Page_Load(ByVal s As Object, ByVal E As EventArgs)
    ...
    End Try
        ...
        Dim report As Reports.InvoiceSingleTicket = CType(Me.ReportViewer1.Report, Reports.InvoiceSingleTicket)
        report = New Reports.InvoiceSingleTicket(System.Configuration.ConfigurationManager.AppSettings("DBCnn"))
...
<form id="form1" runat="server">
    <div>
        <telerik:ReportViewer id="ReportViewer1" runat="server" height="537px" width="100%" zoommode="FullPage" report="Reports.InvoiceSingleTicket, Reports, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null" />
