...
_230._preFullScreenBounds=this.getBounds(_231);
...
var _236;
if(this.IsIE){
_235=document.documentElement.clientWidth;
_236=document.documentElement.clientHeight;
}else{
if(this.IsSafari){
_235=window.innerWidth;
_236=window.innerHeight;
}else{
if(this.IsOpera){
_235=Math.min(window.innerWidth,document.body.clientWidth);
_236=Math.min(window.innerHeight,document.body.clientHeight);
}else{
_235=Math.min(window.innerWidth,document.documentElement.clientWidth);
_236=Math.min(window.innerHeight,document.documentElement.clientHeight);
}
}
}
return {x:0,y:0,width:_235,height:_236};
},getLocationWithScrollOffset:function(_237){
var _238=null;
var pos=[];
var box;
if(_237.getBoundingClientRect){
box=_237.getBoundingClientRect();
var _23b=document.documentElement.scrollTop||document.body.scrollTop;
var _23c=document.documentElement.scrollLeft||document.body.scrollLeft;
var x=box.left+_23c-2;
var y=box.top+_23b-2;
return {x:x,y:y};
}else{
if(document.getBoxObjectFor){
box=document.getBoxObjectFor(_237);
pos=[box.x-1,box.y-1];
}else{
pos=[_237.offsetLeft,_237.offsetTop];
_238=_237.offsetParent;
if(_238!=_237){
while(_238){
pos[0]+=_238.offsetLeft;
pos[1]+=_238.offsetTop;
_238=_238.offsetParent;
}
}
}
}
if(window.opera){
_238=_237.offsetParent;
while(_238&&_238.tagName.toUpperCase()!="BODY"&&_238.tagName.toUpperCase()!="HTML"){
pos[0]-=_238.scrollLeft;
pos[1]-=_238.scrollTop;
_238=_238.offsetParent;
}
}else{
_238=_237.parentNode;
while(_238&&_238.tagName.toUpperCase()!="BODY"&&_238.tagName.toUpperCase()!="HTML"){
pos[0]-=_238.scrollLeft;
pos[1]-=_238.scrollTop;
_238=_238.parentNode;
}
}
return {x:pos[0],y:pos[1]};
},getBounds:function(_23f){
var _240=this.getLocationWithScrollOffset(_23f);
return {x:_240.x,y:_240.y,width:_23f.offsetWidth||0,height:_23f.offsetHeight||0};
...
var _25=_22.replace("--"+">","--RADEDITORSAVEDTAGENDING>");
var _26="<!"+"--RADEDITORSAVEDTAG_"+_21+_25+"--"+">";
return _26;
};
var _27=new RegExp("<(script|noscript)([\\s\\S]*?<\\/\\1)>","ig");
var _28=_1e.replace(_27,_1f);
return _28;
}};
...
RadEditorNamespace.RemoveExtraBrakes.prototype={GetHtmlContent:function(_29){
return this._performStripping(_29);
},_performStripping:function(_2a){
var _2b=_2a;
_2b=_2b.replace(/<BR\s?\/?>\s*<\/(H1|H2|H3|H4|H5|H6|LI|P)/ig,"</$1");
_2b=_2b.replace(/<(H1|H2|H3|H4|H5|H6|LI|P)([^>]*)?><BR\s?\/?>/ig,"<$1 $2>");
return _2b;
}};
...
RadEditorNamespace.FixNestedLists.prototype={_getElements:function(_2c,_2d){
var _2e=_2c.getElementsByTagName(_2d);
if(!_2e){
_2e=_2c.ownerDocument.getElementsByTagName(_2d);
}
return _2e;
},fixLists:function(_2f,_30){
var _31=this._getElements(_2f,_30);
for(var i=_31.length-1;i>=0;i--){
var _33=_31[i];
var _34=_33.previousSibling;
if(_34&&_34.nodeType==3){
_34=_34.previousSibling;
}
if(_34&&"li"==_33.previousSibling.nodeName.toLowerCase()){
_34.appendChild(_33.cloneNode(true));
_33.removeNode(true);
}
}
},GetHtmlContent:function(_35){
this.fixLists(_35,"OL");
this.fixLists(_35,"UL");
return _35;
}};
...
RadEditorNamespace.FixUlBoldItalic.prototype={_getElements:function(_36,_37){
var _38=_36.getElementsByTagName(_37);
if(!_38){
_38=_36.ownerDocument.getElementsByTagName(_37);
}
return _38;
},_replaceElementWithSpan:function(_39,_3a,_3b){
var _3c=this._getElements(_39,_3a);
while(_3c.length>0){
var _3d=_39.ownerDocument.createElement("span");
_3d.style.cssText=_3b;
var _3e=_3c[0].innerHTML;
if(window.RadControlsNamespace.Browser.IsIE&&_3e==" "){
_3d.innerText=_3e;
}else{
RadEditorNamespace.Utils.setElementInnerHtml(_3d,_3e);
}
_3c[0].parentNode.replaceChild(_3d,_3c[0]);
_3c=this._getElements(_39,_3a);
}
},_replaceSpanWithElement:function(_3f,_40,_41){
var _42=this._getElements(_3f,"span");
var _43=_42.length-1;
while(_43>=0){
var _44=[];
var _45=_42[_43];
for(var i=0;i<_45.childNodes.length;i++){
_44[_44.length]=_45.childNodes[i].cloneNode(true);
}
if(_45.style.cssText.toLowerCase()==_41||_45.style.cssText.toLowerCase()==(_41+";")){
var _47=_3f.ownerDocument.createElement(_40);
for(var j=0;j<_44.length;j++){
_47.appendChild(_44[j]);
}
_45.parentNode.replaceChild(_47,_42[_43]);
_42=this._getElements(_3f,"span");
_43=_42.length-1;
}else{
_43--;
}
}
},GetHtmlContent:function(_49){
this._replaceElementWithSpan(_49,"u","text-decoration:underline;");
return _49;
},GetDesignContent:function(_4a){
this._replaceSpanWithElement(_4a,"u","text-decoration: underline");
return _4a;
}};
...
RadEditorNamespace.IEKeepCommentsFilter.prototype={GetHtmlContent:function(_4b){
var _4c=new RegExp("<!"+"--RADEDITORSAVEDCOMMENT","ig");
var _4d=_4b.replace(_4c,"<!--");
return _4d;
},GetDesignContent:function(_4e){
var _4f=new RegExp("<!"+"--(\\[[^]]+\\][\\s\\S]*?)-"+"->","ig");
var _50=_4e.replace(_4f,"<!-"+"-RADEDITORSAVEDCOMMENT$1-"+"->");
return _50;
}};
...
RadEditorNamespace.IEKeepObjectParamsFilter.prototype={GetHtmlContent:function(_51){
var _52=new RegExp("<param([\\s\\S]+?)?>","ig");
var _53=new RegExp("<rade_param([\\s>])","ig");
var _54=_51;
if(_52.test(_51)&&_53.test(_51)){
_54=_54.replace(_52,"");
}
_54=_54.replace(_53,"<param$1");
_54=_54.replace(/<\/rade_param>/gi,"");
return _54;
},GetDesignContent:function(_55){
var _56=new RegExp("<param([\\s\\S]+?)/?>","ig");
var _57=_55.replace(_56,"<rade_param$1></rade_param><param$1>");
return _57;
}};
...
RadEditorNamespace.FixEnclosingP.prototype={_removeNode:function(_58){
var _59=[];
var _5a=_58.parentNode;
if(_5a!=null){
for(var i=0;i<_58.childNodes.length;i++){
_59[_59.length]=_58.childNodes[i].cloneNode(true);
}
for(var i=0;i<_59.length;i++){
_5a.insertBefore(_59[i],_58);
}
_5a.removeChild(_58);
return _5a;
}
return true;
},GetHtmlContent:function(_5c){
var _5d=null;
if(_5c.tagName.toLowerCase()=="html"){
_5d=_5c.getElementsByTagName("BODY")[0];
}else{
_5d=_5c;
}
if(window.RadControlsNamespace.Browser.IsIE){
if(_5d&&(_5d.firstChild)&&("P"==_5d.firstChild.tagName)&&(_5d.childNodes.length==1)&&(_5d.innerHTML.substring(0,3).toLowerCase()=="<p>")){
this._removeNode(_5d.firstChild);
}
}else{
if(_5d&&(_5d.childNodes.length==1)&&(_5d.firstChild.tagName)&&("br"==_5d.firstChild.tagName.toLowerCase())){
_5d.innerHTML="";
}
}
return _5c;
...
RadEditorNamespace.IECleanAnchorsFilter.prototype={GetHtmlContent:function(_5e){
var _5f=document.location.href;
var re=new RegExp("(<A[^<>]*?(href)\\s*=\\s*['\"])("+_5f+")(\\#[^'\"]*?['\"][^>]*?>)","ig");
var _61=_5e.replace(re,"$1$4");
return _61;
}};
...
RadEditorNamespace.MozEmStrongFilter.prototype={GetHtmlContent:function(_62){
var _63=_62.replace(new RegExp("<b(\\s([^>])*?)?>","ig"),"<strong$1>");
_63=_63.replace(new RegExp("</b(\\s([^>])*?)?>","ig"),"</strong$1>");
_63=_63.replace(new RegExp("<i(\\s([^>])*?)?>","ig"),"<em$1>");
_63=_63.replace(new RegExp("</i(\\s([^>])*?)?>","ig"),"</em$1>");
return _63;
},GetDesignContent:function(_64){
var _65=_64.replace(new RegExp("<strong(\\s([^>])*?)?>","ig"),"<b$1>");
_65=_65.replace(new RegExp("</strong(\\s([^>])*?)?>","ig"),"</b$1>");
_65=_65.replace(new RegExp("<em(\\s([^>])*?)?>","ig"),"<i$1>");
_65=_65.replace(new RegExp("</em(\\s([^>])*?)?>","ig"),"</i$1>");
return _65;
}};
...
RadEditorNamespace.MozillaKeepStylesString.prototype={GetDesignContent:function(_66){
var _67=this;
var _68=function(_69,_6a,_6b,_6c,_6d){
var _6e=_6d.indexOf("</head>",_6c);
if(_6e!=-1&&_6d.indexOf("<body",_6e)!=-1){
return _69;
}else{
_67.markerCounter++;
var _6f="RadEditorStyleKeeper"+_67.markerCounter;
var _70="<div id='"+_6f+"' style='display:none;'>&nbsp;</div><"+_6a+" reoriginalpositionmarker='"+_6f+"'"+_6b;
return _70;
}
};
var _71=new RegExp("<(link|style)([^>]*>)","gi");
var _72=_66.replace(_71,_68);
return _72;
}};
...
RadEditorNamespace.MozillaKeepStylesDom.prototype={GetHtmlContent:function(_73){
var _74=_73.getElementsByTagName("HEAD")[0];
if(!_74){
_74=_73.ownerDocument.getElementsByTagName("HEAD")[0];
}
if(!_74){
return _73;
}
var _75=_74.getElementsByTagName("STYLE");
var _76=_74.getElementsByTagName("LINK");
this._divs=_73.getElementsByTagName("DIV");
var i=0;
this._changed=false;
while(_75.length>0&&i<_75.length){
this._restoreElement(_75[i++]);
if(this._changed){
this._changed=false;
_75=_74.getElementsByTagName("STYLE");
this._divs=_74.getElementsByTagName("DIV");
i=0;
}
}
var i=0;
this._changed=false;
while(_76.length>0&&i<_76.length){
this._restoreElement(_76[i++]);
if(this._changed){
this._changed=false;
_76=_74.getElementsByTagName("LINK");
this._divs=_74.getElementsByTagName("DIV");
i=0;
}
}
...
this._divs=null;
_75=_73.ownerDocument.getElementsByTagName("STYLE");
if(_75){
for(var j=_75.length-1;j>=0;j--){
_75[j].removeAttribute("reoriginalpositionmarker");
}
}
_76=_73.ownerDocument.getElementsByTagName("LINK");
if(_76){
for(var j=_76.length-1;j>=0;j--){
_76[j].removeAttribute("reoriginalpositionmarker");
}
}
return _73;
},_restoreElement:function(_7b){
var _7c=_7b.getAttribute("reoriginalpositionmarker");
if(_7c){
_7b.removeAttribute("reoriginalpositionmarker");
this._changed=true;
j=0;
var _7d=null;
while(j<this._divs.length&&!_7d){
if(this._divs[j].id==_7c){
_7d=this._divs[j];
}
j++;
}
if(_7d){
var _7e=_7b.parentNode;
var _7f=_7d.parentNode;
_7e.removeChild(_7b);
_7f.replaceChild(_7b,_7d);
}else{
var _7e=_7b.parentNode;
_7e.removeChild(_7b);
}
...
RadEditorNamespace.MozillaKeepFlashString=function(_80){
this.IsDom=false;
this.Enabled=true;
...
this._flashImageSrc=_80?_80:"FlashManager.gif";
};
RadEditorNamespace.MozillaKeepFlashString.prototype={GetDesignContent:function(_81){
var _82=this;
var _83=function(_84,gr1,gr2,gr3,str,_89){
var _8a="<img isflash=\"true\" "+gr1+" />"+gr2;
_8a=_8a.replace(/\ssrc=/gi," src=\""+_82._flashImageSrc+"\" flashSrc=");
return _8a;
};
var _8b=new RegExp("<embed([^>]*)?>(.*)?(<\\/embed>)?","ig");
var _8c=_81.replace(_8b,_83);
return _8c;
}};
...
RadEditorNamespace.MozillaKeepFlash.prototype={GetHtmlContent:function(_8d){
if(!_8d){
return _8d;
}
var _8e=_8d.getElementsByTagName("IMG");
for(var i=0;i<_8e.length;i++){
var _90=_8e[i];
var _91=_90.getAttribute("isflash");
if(_91!=null){
var _92=_90.getAttribute("flashSrc");
var _93=RadEditorNamespace.Utils.GetOuterHtml(_90);
_93=_93.replace(/<img/gi,"<embed");
var _94=_90.ownerDocument.createElement("DIV");
_94.innerHTML=_93;
newNode=_94.firstChild;
if(_92){
newNode.src=_92;
if(window.RadControlsNamespace.Browser.IsSafari){
newNode.setAttribute("src",_92);
}
}
newNode.removeAttribute("flashSrc");
newNode.removeAttribute("isflash");
var _95=_90.parentNode;
_95.insertBefore(newNode,_90);
_95.removeChild(_90);
i--;
}
}
...
RadEditorNamespace.StripJunkFilter.prototype={GetHtmlContent:function(_96){
var _97=_96;
if(window.RadControlsNamespace.Browser.IsSafari){
_97=_97.replace(new RegExp(" class=\"khtml-block-placeholder\"","ig"),"");
_97=_97.replace(new RegExp(" class=\"Apple-style-span\"","ig"),"");
_97=_97.replace(new RegExp(" class=\"webkit-block-placeholder\"","ig"),"");
}
if(window.RadControlsNamespace.Browser.IsFirefox){
_97=_97.replace(new RegExp("\\s?<br type=\"_moz\" \\/>","ig")," ");
_97=_97.replace(new RegExp(" _moz_[a-z_]*=\"[^\"]*\"","ig"),"");
_97=_97.replace(new RegExp(" type=\"_moz\"","ig"),"");
}
return _97;
}};
...
},GetHtmlContent:function(_99){
var _9a=_99.ownerDocument;
var _9b=_9a.createElement("SPAN");
var _9c,_9d,_9e;
var _9f=_99.getElementsByTagName("FONT");
while(_9f.length>0){
_9d=_9f[0];
_9e=_9d.parentNode;
_9c=_9b.cloneNode(false);
RadEditorNamespace.Utils.MergeElementAttributes(_9d,_9c,false);
if(_9d.style.cssText&&_9d.style.cssText!=""){
_9c.style.cssText=_9d.style.cssText;
}
if(_9d.className){
_9c.className=_9d.className;
}
if(_9d.face){
_9c.style.fontFamily=_9d.face;
}
var _a0=0;
if(_9d.style.fontSize){
_9c.style.fontSize=_9d.style.fontSize;
}else{
if(!isNaN(_a0=parseInt(_9d.size))){
try{
if(_a0<0){
_a0=_a0+4;
}
_9c.style.fontSize=this._fontSizes[_a0-1];
}
catch(ex){
_9c.style.fontSize=this._fontSizes[3];
}
}
}
if(_9d.color){
_9c.style.color=_9d.color;
}
if(window.RadControlsNamespace.Browser.IsIE&&_9d.innerHTML==" "){
_9c.innerText=_9d.innerHTML;
}else{
RadEditorNamespace.Utils.setElementInnerHtml(_9c,_9d.innerHTML);
}
_9e.replaceChild(_9c,_9d);
_9f=_99.getElementsByTagName("FONT");
}
return _99;
},GetDesignContent:function(_a1){
var _a2=_a1.ownerDocument;
var _a3=_a2.createElement("FONT");
var _a4,_a5,_a6;
var _a7=_a1.getElementsByTagName("SPAN");
while(_a7.length>0){
_a4=_a7[0];
_a6=_a4.parentNode;
_a5=_a3.cloneNode(false);
RadEditorNamespace.Utils.MergeElementAttributes(_a4,_a5,false);
if(_a4.style.cssText&&_a4.style.cssText!=""){
_a5.style.cssText=_a4.style.cssText;
}
if(_a4.className){
_a5.className=_a4.className;
}
if(_a4.style.fontFamily){
_a5.face=_a4.style.fontFamily;
if(window.RadControlsNamespace.Browser.IsIE){
_a5.style.removeAttribute("fontFamily");
}else{
_a5.style.fontFamily=null;
}
}
if(_a4.style.fontSize){
var _a8=3;
var _a9=this._fontSizesRev[parseInt(_a4.style.fontSize)];
if(typeof (_a9)!="undefined"){
_a5.size=_a9+1;
this._removeElementStyleAttribute(_a5,"fontSize");
}
}
if(_a4.style.color){
if(window.RadControlsNamespace.Browser.IsIE){
_a5.color=_a4.style.color;
_a5.style.removeAttribute("color");
}
}
if(window.RadControlsNamespace.Browser.IsIE&&_a4.innerHTML==" "){
_a5.innerText=_a4.innerHTML;
}else{
RadEditorNamespace.Utils.setElementInnerHtml(_a5,_a4.innerHTML);
}
_a6.replaceChild(_a5,_a4);
_a7=_a1.getElementsByTagName("SPAN");
}
return _a1;
},_removeElementStyleAttribute:function(_aa,_ab){
if(_aa.style&&_aa.style[_ab]){
_aa.style[_ab]=null;
if(_aa.style.removeAttribute){
_aa.style.removeAttribute(_ab);
}
if(_aa.style.cssText){
}else{
_aa.removeAttribute("style");
}
}
}};
...
},GetHtmlContent:function(_ac){
if(!_ac){
return "";
}
var sb=new RadEditorNamespace.Utils.StringBuilder("");
this._appendNodeXhtml(_ac,sb);
return sb.ToString();
},_convertAttribute:function(s){
return String(s).replace(/\&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\"/g,"&quot;");
},_getAttributeValue:function(_af,_b0,sb){
var _b2=_af.nodeName;
var _b3=_af.nodeValue;
if(window.RadControlsNamespace.Browser.IsIE&&(_b2=="type"||_b2=="value"||_b2=="selected")){
if(!_b3){
return;
}
}else{
...
if(!isNaN(_b3)){
_b3=_b0.getAttribute(_b2);
}
if(window.RadControlsNamespace.Browser.IsIE&&(_b2=="href"||_b2=="src")){
_b3=_b0.getAttribute(_b2,2);
}
sb.Append(" "+(_af.expando?_b2:_b2.toLowerCase())+"=\""+this._convertAttribute(_b3)+"\"");
}else{
var _b5=_b0.style.cssText;
if(_b5){
sb.Append(" style=\""+this._convertAttribute(_b5.toLowerCase())+"\"");
}
}
},_canHaveChildren:function(_b6){
switch(_b6.tagName.toUpperCase()){
case "AREA":
case "BASE":
case "BASEFONT":
case "COL":
...
return true;
},_appendElementNode:function(_b7,sb){
if(_b7.tagName.charAt(0)=="/"){
return;
}
if(_b7.nodeName=="!"){
sb.Append(_b7.text);
...
var _b9=_b7.nodeName;
if(_b7.scopeName){
if(_b7.scopeName=="HTML"){
_b9=_b9.toLowerCase();
}else{
_b9=_b7.scopeName+":"+_b9;
}
}else{
_b9=_b9.toLowerCase();
}
...
_ba.mergeAttributes(_b7);
if(_ba.width){
sb.Append(" width=\""+_b7.getAttribute("width",2)+"\"");
}
if(_ba.height){
sb.Append(" height=\""+_b7.getAttribute("height",2)+"\"");
}
if(_ba.getAttribute("alt").length==0){
sb.Append(" alt=\""+_ba.getAttribute("alt")+"\"");
}
}else{
if("area"==_b9||"a"==_b9){
if(_b7.shape){
sb.Append(" shape=\""+_b7.shape.toLowerCase()+"\"");
}
if(_b7.coords){
sb.Append(" coords=\""+_b7.getAttribute("coords")+"\"");
}
if(_b7.href){
var _bb=_b7.getAttribute("href",2).replace("about:blank","");
_bb=_bb.replace("about:","");
sb.Append(" href=\""+_bb+"\"");
_b7.removeAttribute("href",0);
}
}
}
}
try{
var _bc=_b7.attributes;
var l=_bc.length;
for(var i=0;i<l;i++){
this._getAttributeValue(_bc[i],_b7,sb);
}
}
catch(exc){
}
switch(_b9){
case "script":
sb.Append(">"+_b7.text+"</"+_b9+">");
break;
case "textarea":
sb.Append(">"+_b7.value+"</"+_b9+">");
break;
case "iframe":
sb.Append("></iframe>");
break;
...
if(window.RadControlsNamespace.Browser.IsIE){
_bf=_bf.replace(/\soriginalAttribute="[^"]+"/gi,"");
_bf=_bf.replace(/\soriginalPath="[^"]+"/gi,"");
}
sb.Append(_bf);
sb.Append("</object>");
break;
...
case "comment":
case "noscript":
var _bf=_b7.innerHTML;
if(window.RadControlsNamespace.Browser.IsIE&&_bf.length==0){
_bf=_b7.ownerDocument.title;
}
sb.Append(">"+_bf+"</"+_b9+">");
break;
default:
if(_b7.hasChildNodes()||(true==_b7.canHaveChildren||(_b7.canHaveChildren==null&&this._canHaveChildren(_b7)))){
sb.Append(">");
var cs=_b7.childNodes;
l=cs.length;
for(var i=0;i<l;i++){
...
},_appendTextNode:function(_c1,sb){
var _c3=String(_c1.nodeValue);
var _c4=_c1.parentNode.nodeName.toLowerCase();
if(!window.RadControlsNamespace.Browser.IsIE&&(_c4=="style"||_c4=="script")){
sb.Append(_c3);
}else{
_c3=_c3.replace(/\&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");
if(window.RadControlsNamespace.Browser.IsFirefox){
_c3=_c3.replace(/[\u00a0]/g,"&nbsp;");
}
sb.Append(_c3);
}
},_appendCDataNode:function(_c5,sb){
sb.Append("<![CDA"+"TA[\n"+_c5.nodeValue+"\n]"+"]>");
},_appendCommentNode:function(_c7,sb){
var _c9=_c7.nodeValue;
if(!_c9&&_c7.text){
_c9=_c7.text;
}else{
_c9="<!--"+_c9+"-->";
...
sb.Append(_c9);
},_appendNodeXhtml:function(_ca,sb){
if(_ca.uniqueID){
if(this._uniqueIds[_ca.uniqueID]){
return;
}else{
this._uniqueIds[_ca.uniqueID]=true;
}
}
switch(_ca.nodeType){
case 1:
this._appendElementNode(_ca,sb);
break;
case 3:
this._appendTextNode(_ca,sb);
break;
case 4:
this._appendCDataNode(_ca,sb);
break;
case 8:
this._appendCommentNode(_ca,sb);
break;
}
}};
...
var _cc="P|DIV|H1|H2|H3|H4|H5|H6|ADDRESS|PRE|OL|UL|LI|TITLE|META|LINK|BASE|SCRIPT|LINK|TD|TH|AREA|OPTION";
var _cd="HTML|HEAD|BODY|STYLE|FORM|TABLE|TBODY|THEAD|TR";
var _ce=_cd+"|UL|OL";
this._ignoreTags=new RegExp("(<PRE[^>]*>|<!--)([\\s\\S]*?)(<\\/PRE>|-->)","gi");
this._tagsNLBefore=new RegExp("<("+_cc+")[^>]*>","gi");
this._tagsNLAfter=new RegExp("<\\/("+_cc+")[^>]*>","gi");
this._tagsNLNoCloseAfter=new RegExp("<(BR|HR)[^>]*\\/?>","gi");
this._tagsNLBeforeAndAfter=new RegExp("<\\/?("+_cd+")[^>]*>","gi");
this._tagsIncIndent=new RegExp("^<("+_ce+")[\\s\\/>]","i");
this._tagsDecIndent=new RegExp("^<\\/("+_ce+")[\\s\\>]","i");
this._shrinkNL=new RegExp("\\s*\\n+\\s*","gi");
};
RadEditorNamespace.IndentHTMLContentFilter.prototype={dispose:function(){
this._protectedData=[];
},GetHtmlContent:function(_cf){
var _d0=RadEditorNamespace.Utils.Trim(_cf);
if(_d0.indexOf("<body")==0){
_d0=_d0.substring(_d0.indexOf(">")+1,_d0.length-7);
}
this._protectedData=[];
var _d1=this;
var _d2=function(_d3,_d4,_d5,_d6,_d7,_d8){
_d1._protectedData[_d1._protectedData.length]=_d5;
return _d4+"RADEDITORFORMATTED_"+_d1._protectedData.length+_d6;
};
_cf=_cf.replace(this._ignoreTags,_d2);
var _d9="$&";
if(window.RadControlsNamespace.Browser.IsSafari){
_d9="$0";
}
_d0=_d0.replace(this._tagsNLBefore,"\n"+_d9);
_d0=_d0.replace(this._tagsNLAfter,_d9+"\n");
_d0=_d0.replace(this._tagsNLNoCloseAfter,_d9+"\n");
_d0=_d0.replace(this._tagsNLBeforeAndAfter,"\n"+_d9+"\n");
var _da=_d0.split(this._shrinkNL);
var _db=new RadEditorNamespace.Utils.StringBuilder("");
var _dc="";
for(var i=0;i<_da.length;i++){
var _de=_da[i];
if(_de.length==0){
...
if(this._tagsDecIndent.test(_de)){
if(_dc.length>this._indentPattern.length){
_dc=_dc.substring(this._indentPattern.length);
}else{
_dc="";
}
}
...
_db.Append(_de);
_db.Append("\n");
if(this._tagsIncIndent.test(_de)){
_dc+=this._indentPattern;
}
}
_d0=_db.ToString();
for(var i=0;i<this._protectedData.length;i++){
var _df=new RegExp("RADEDITORFORMATTED_"+(i+1));
_d0=_d0.replace(_df,this._protectedData[i]);
}
return _d0;
}};
RadEditorNamespace.MakePathsAbsolute=function(_e0){
this.IsDom=true;
this.Enabled=true;
...
RadEditorNamespace.MakePathsAbsolute.prototype={GetHtmlContent:function(_e1){
if("href"==this.attrName){
this._updateElements(_e1,"A","href");
this._updateElements(_e1,"AREA","href");
}else{
if("src"==this.attrName){
this._updateElements(_e1,"IMG","src");
this._updateElements(_e1,"EMBED","src");
}
}
return _e1;
},_getElements:function(_e2,_e3){
var _e4=_e2.getElementsByTagName(_e3);
if(!_e4){
_e4=_e2.ownerDocument.getElementsByTagName(_e3);
}
return _e4;
},_updateElements:function(_e5,_e6,_e7){
var _e8=_e5.ownerDocument.createElement("div");
var _e9=this._getElements(_e5,_e6);
if(_e9){
for(var i=0;i<_e9.length;i++){
if("href"==_e7){
_e8.innerHTML="<a href='"+_e9[i].getAttribute("href",2)+"'>test</a>";
_e9[i].setAttribute("href",_e8.childNodes[0].href);
}else{
_e8.innerHTML="<img src='"+_e9[i].getAttribute("src",2)+"' />";
_e9[i].setAttribute("src",_e8.childNodes[0].src);
}
}
}
_e8.innerHTML="";
...
RadEditorNamespace.RadStripPathFilter=function(_eb,_ec){
this.Name="RadStripPathFilter";
this.Description="This filter strips an image or an anchor path";
this.TagName=_eb;
this.PathToStrip=_ec;
this.GetHtmlContent=function(_ed){
if(!document.all){
return _ed;
}else{
var _ee=StripAbsolutePaths(_ed,this.TagName,this.PathToStrip);
return _ee;
}
return _ed;
};
function StripAbsolutePaths(_ef,_f0,_f1){
var _f2=function(_f3,_f4,_f5,_f6){
_f6=RadEditorNamespace.Utils.EscapeRegexSpecialChars(_f6);
var _f7=new RegExp("(<"+_f4+"[^<>]*?("+_f5+")\\s*=\\s*['\"])("+_f6+")([^'\"]*?['\"][^>]*?>)","ig");
return _f3.replace(_f7,"$1$4");
};
var _f8=function(_f9,_fa,_fb){
if(_fa=="A"){
var _fc=document.location.href;
_fc=RadEditorNamespace.Utils.EscapeRegexSpecialChars(_fc);
var re=new RegExp("(<A[^<>]*?(href)\\s*=\\s*['\"])("+_fc+")(\\#[^'\"]*?['\"][^>]*?>)","ig");
_f9=_f9.replace(re,"$1$4");
}
var _fe=_f9;
var _ff=(_fa=="A"?"href":"src");
for(var i=0;i<_fb.length;i++){
if(_fb[i]){
_fe=_f2(_fe,_fa,_ff,_fb[i]);
}
}
return _fe;
};
...
var _102=window.location;
_101[0]=_102.protocol+"//"+_102.host+(_102.port?":"+_102.port:"");
var _103=_102.pathname;
var _104=_103.lastIndexOf("/");
if(_104>-1){
_101[1]=_103.substr(0,_104+1);
}
}
return _f8(_ef,_f0,_101);
}
