...
<script runat="server">  
  ...
  Private Sub Page_Load(ByVal s As Object, ByVal E As EventArgs)
    If User.Identity.IsAuthenticated Then
      ...
      Master.PageHeaderText = "Un-Decline Resume"
      Master.PageTitleText = "Un-Decline Resume"
      Master.PageSubHeader = "<a href=""default.aspx"">My Desktop</a> &gt; <a href=""recruit.aspx"">Recruitement</a> &gt; <a href=""resume.aspx?resumeid=" & Request.QueryString("id") & """>View Resume</a> &gt; Un-Decline Resume"
    End If
    Try
  ...
  Private Sub btnSubmit_Click(ByVal S As Object, ByVal E As EventArgs)
    If txtReason.Text.Trim.Length > 0 Then
      ...
      rnt.Add(rsm.ResumeID, Master.UserID, "This Resume was Un-Declined Because:" & txtReason.Text.Trim)
...
<asp:Content ContentPlaceHolderID="bodycontent" ID="cntBody" runat="server">
  <form id="frmDialog" runat="server">
    ...
    <div class="label">Reason for un-declining resume <asp:Label ID="lblResumeID" runat="server" /></div>
