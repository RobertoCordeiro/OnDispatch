...
Namespace BridgesInterface
    Public Class UserPhoneNumberRecord
        ' Methods
        Public Sub New()
            Me._UserPhoneNumberID = -1
            Me._UserID = -1
            Me._PhoneTypeID = -1
            Me._CreatedBy = -1
            Me._CountryCode = ""
        ...
        Public Sub New(ByVal lngUserPhoneNumberID As Long, ByVal strConnectionString As String)
            Me._UserPhoneNumberID = -1
            Me._UserID = -1
            Me._PhoneTypeID = -1
            Me._CreatedBy = -1
        ...
        Public Sub New(ByVal lngUserID As Long, ByVal lngPhoneTypeID As Long, ByVal lngCreatedBy As Long, ByVal strCountryCode As String, ByVal strAreaCode As String, ByVal strExchange As String, ByVal strLineNumber As String, ByVal strConnectionString As String, ByVal Optional strExtension As String = "", ByVal Optional strComment As String = "", ByVal Optional strPin As String = "")
            ...
            Me.Pin = strPin
            Me.Add
            If (Me._UserPhoneNumberID > 0) Then
        ...
        Public Function Add() As Long
            ...
            If (Me._ConnectionString.Trim.Length > 0) Then
                ...
                Dim cmd As New SqlCommand("spAddUserPhoneNumber")
        ...
        Public Sub Add(ByVal lngUserID As Long, ByVal lngPhoneTypeID As Long, ByVal lngCreatedBy As Long, ByVal strCountryCode As String, ByVal strAreaCode As String, ByVal strExchange As String, ByVal strLineNumber As String)
            Me._UserID = lngUserID
            Me._PhoneTypeID = lngPhoneTypeID
            Me._CreatedBy = lngCreatedBy
            Me.CountryCode = strCountryCode
        ...
        Public Sub Delete()
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spRemoveUserPhoneNumber")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@UserPhoneNumberID", SqlDbType.Int).Value = Me._UserPhoneNumberID
                cnn.Open
                cmd.Connection = cnn
                cmd.ExecuteNonQuery
                cnn.Close
                Me.Load(Me._UserPhoneNumberID)
            End If
        End Sub
        ...
        Private Function HasChanged() As Boolean
            ...
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim phnCompare As New UserPhoneNumberRecord(Me._UserPhoneNumberID, Me._ConnectionString)
        ...
        Public Sub Load(ByVal lngUserPhoneNumberID As Long)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spGetUserPhoneNumber")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@UserPhoneNumberID", SqlDbType.Int).Value = lngUserPhoneNumberID
                cnn.Open
                cmd.Connection = cnn
                Dim dtr As SqlDataReader = cmd.ExecuteReader
                If dtr.Read Then
                    Me._UserPhoneNumberID = Conversions.ToLong(dtr.Item("UserPhoneNumberID"))
        ...
        Private Sub UpdateActive(ByVal NewActive As Boolean)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateUserPhoneNumberActive")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@UserPhoneNumberID", SqlDbType.Int).Value = Me._UserPhoneNumberID
        ...
        Private Sub UpdateAreaCode(ByVal NewAreaCode As String)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateUserPhoneNumberAreaCode")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@UserPhoneNumberID", SqlDbType.Int).Value = Me._UserPhoneNumberID
        ...
        Private Sub UpdateComment(ByVal NewComment As String)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateUserPhoneNumberComment")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@UserPhoneNumberID", SqlDbType.Int).Value = Me._UserPhoneNumberID
        ...
        Private Sub UpdateCountryCode(ByVal NewCountryCode As String)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateUserPhoneNumberCountryCode")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@UserPhoneNumberID", SqlDbType.Int).Value = Me._UserPhoneNumberID
        ...
        Private Sub UpdateExchange(ByVal NewExchange As String)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateUserPhoneNumberExchange")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@UserPhoneNumberID", SqlDbType.Int).Value = Me._UserPhoneNumberID
        ...
        Private Sub UpdateExtension(ByVal NewExtension As String)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateUserPhoneNumberExtension")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@UserPhoneNumberID", SqlDbType.Int).Value = Me._UserPhoneNumberID
        ...
        Private Sub UpdateLineNumber(ByVal NewLineNumber As String)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateUserPhoneNumberLineNumber")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@UserPhoneNumberID", SqlDbType.Int).Value = Me._UserPhoneNumberID
        ...
        Private Sub UpdatePhoneTypeID(ByVal NewPhoneTypeID As Long)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateUserPhoneNumberPhoneTypeID")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@UserPhoneNumberID", SqlDbType.Int).Value = Me._UserPhoneNumberID
        ...
        Private Sub UpdatePin(ByVal NewPin As String)
            If (Me._ConnectionString.Trim.Length > 0) Then
                Dim cnn As New SqlConnection(Me._ConnectionString)
                Dim cmd As New SqlCommand("spUpdateUserPhoneNumberPin")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@UserPhoneNumberID", SqlDbType.Int).Value = Me._UserPhoneNumberID
        ...
        Public ReadOnly Property UserPhoneNumberID As Long
            Get
                Return Me._UserPhoneNumberID
            End Get
        End Property
        ...
        Private _UserPhoneNumberID As Long
