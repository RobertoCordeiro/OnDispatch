...
<script runat="server"> 
  ...
  Private Sub Page_Load(ByVal s As Object, ByVal E As EventArgs)    
    If User.Identity.IsAuthenticated Then
      ...
      Master.PageHeaderText = "Add Partner Agent"
      Master.PageTitleText = "Add Partner Agent"
    End If
    Try
    ...
    if lblReturnUrl.Text <> "" then
      ...
      lblReturnUrl.Text = "partner.aspx?id=" & _ID
    end if
  ...
  Private Sub LoadUnassignedPhoneNumbers()
    ...
    ldr.LoadSingleLongParameterDataGrid("spListPartnerPhoneNumbers", "@PartnerID", _ID, Me.dgvUnassignedPhoneNumbers)
    lblUnassociatedCount.Text = dgvUnassignedPhoneNumbers.Items.Count
  End Sub

  Private Sub LoadUnassignedAddresses()
    Dim ldr As New cvCommon.Loaders(System.Configuration.ConfigurationManager.AppSettings("DBCnn"))
    ldr.LoadSingleLongParameterDataGrid("spListPartnerAddresses", "@PartnerID", _ID, Me.dgvUnassignedAddresses)
  ...
  Private Sub Save()
    ...
    Dim wbl As New BridgesInterface.WebLoginRecord(System.Configuration.ConfigurationManager.AppSettings("DBcnn"))
        ...
        par.Add(_ID, CType(cbxAgentTypes.SelectedValue, Long), Master.UserID, fnlAgent.FirstName, fnlAgent.LastName)
  ...
  Private Sub btnAddPhone_Click(ByVal S As Object, ByVal E As EventArgs)
    If IsPhoneComplete() Then
      ...
      ppr.Add(_ID, phn.PhoneTypeID, Master.UserID, "1", phn.AreaCode, phn.Exchange, phn.LineNumber)
      ppr.Pin = phn.Pin
