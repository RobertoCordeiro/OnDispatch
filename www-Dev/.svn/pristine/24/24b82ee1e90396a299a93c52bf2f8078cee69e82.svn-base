...
<script runat="server">
  ...
  Private Sub Page_Load(ByVal s As Object, ByVal E As EventArgs)
    ...
    End If
      ...
      If com.CustomerID = _ID then
         ...
         _ReturnUrl  = "mycompany.aspx?id=" & _ID & "&t=4&&infoID=" & cus.InfoID
         lblReturnUrl.Text = _ReturnUrl
      else
  ...
  Private Sub SavePartnerAddress()
    ...
    pad.Add(_ID, Master.UserID, addAddress.StateID, addAddress.AddressTypeID, addAddress.Street, addAddress.City, addAddress.Zip)
