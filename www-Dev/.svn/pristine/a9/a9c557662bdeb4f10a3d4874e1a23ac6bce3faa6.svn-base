<%@ Page Language="vb" masterpagefile="~/masters/eudialog.master" %>
<%@ MasterType VirtualPath="~/masters/eudialog.master" %>
<script runat="server">  
    ...
    If IsComplete() Then
      ...
      Select Case _Mode.ToLower
        Case "doc"
         ...
         act.Add(2 ,"web", strType,strIp,2,43, _TicketID, strChangeLog)
  ...
  Private Function UploadFile() As Long
    ...
    Dim tnt As New BridgesInterface.TicketNoteRecord(System.Configuration.ConfigurationManager.AppSettings("DBCnn"))
      tnt.Add(_TicketID, 2, 1, "Auto Note: New Attachment has been added to the ticket: " & drpDocTypes.SelectedItem.text )
  ...
  Private Function UpdateUploadFile(lngFileID as long) As Long
    ...
    fil.Add(2 , strFileName, strExtension.Replace(".", ""),buf)
      ...
      Dim tnt As New BridgesInterface.TicketNoteRecord(System.Configuration.ConfigurationManager.AppSettings("DBCnn"))
      tnt.Add(_TicketID, 2, 1, "Auto Note: Ticket has been updated with Attachment: " & drpDocTypes.SelectedItem.text )
      tnt.CustomerVisible = False
      tnt.PartnerVisible = False
      tnt.Acknowledged = True
      tnt.SourceID = BridgesInterface.TicketNoteRecord.Sources.Internal
  ...
  Private Sub LoadDocTypes()
    ...
    ldr.LoadSimpleDropDownList("spGetTicketDocumentTypes","Description","TicketDocumentTypeID",drpDocTypes)
...
<asp:Content ContentPlaceHolderID="bodycontent" ID="cntBody" runat="server">
  <form id="frmDialog" runat="server">
    ...
    <div>&nbsp;</div> 
    <div><b>*** Attention: This feature is for uploading Proof of Purchase,<br /> Photos, etc. related to this onsite service only.</b></div> 
