...
<script runat="server"> 
  ...
  Private Sub Page_Load(sender as Object, e as EventArgs)
        If User.Identity.IsAuthenticated Then
            ...
            Master.PageHeaderText = " Download Phone System "
            Master.PageTitleText = " Download Phone System "
        End If
        Try
        ...
        If _ID = "0" Then
            ...
            Dim dirInfo As New DirectoryInfo(Server.MapPath("../PhoneSystem/"))
      
            dgvManuals.DataSource = dirInfo.GetFiles("*.e**")
            dgvManuals.DataBind()
