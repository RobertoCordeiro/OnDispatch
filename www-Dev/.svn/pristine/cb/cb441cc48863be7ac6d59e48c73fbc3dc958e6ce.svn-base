...
<script runat="server">
  ...
  Private Sub Page_Load(ByVal s As Object, ByVal E As EventArgs)
    If User.Identity.IsAuthenticated Then
      ...
      Master.PageSubHeader = "<a href=""default.aspx"">My Desktop</a> &gt; Edit Phone Number"
    End If
  ...
  Private Sub SaveResumePhone()
    ...
    If IsNothing(strType) Then
      strType = "web"
    End If
    act.Add(Master.UserID, "Web", strType, strIp, Master.WebLoginID, 22, rpn.ResumePhoneNumberID, strChangeLog)
  End Sub
