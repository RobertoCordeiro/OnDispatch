...
<script runat="server">
  ...
  Private Sub Page_Load(ByVal S As Object, ByVal E As EventArgs)
    ...
    Dim strDefaultText As String = "Welcome to the Global Office."
    TrackTraffic()
    If Not IsNothing(strRef) Then
      Try
        Select Case strRef.Split("/")(1).ToLower
          Case "partners"
            lblWelcome.Text = "Welcome to the Global Office Partner Interface"
          Case "agentinterface"
            lblWelcome.Text = "Welcome to the Global Office Agent Interface"
          Case "clients"
            lblWelcome.Text = "Welcome to the Global Office Client Interface"
          Case Else
...
<asp:Content ID="cntLogin" ContentPlaceHolderID="cntMain1" runat="server">
  <form id="frmLogin" runat="server" >
    ...
    <div>&nbsp;</div>
    <div>User Name</div>                
    <div><asp:textbox style="width: 98%" id="txtUserName" runat="server" /></div>
    <div>Password</div>
    <div><asp:textbox TextMode="password" style="width: 98%" id="txtPassword" runat="server" /></div>
    <div><asp:CheckBox ID="chkRememberMe" runat="server" Text="Remember me" /></div>
